...
console.assert(('hello' || 123) === 'hello', "|| returns the first element if two true!")
...
console.assert(item + 0 === '{"name":"Leo","age":35}0')
// console.log('!!item is true?', !!item)
console.assert(!!item)

// console.log('string.concat', 'Ae'.concat(item))
console.assert('Ae'.concat(item) === 'Ae{"name":"Leo","age":35}')
