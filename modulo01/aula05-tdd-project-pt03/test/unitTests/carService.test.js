...
describe('CarService Suite Tests', () => {
    ...
    it('given a carCategory, customer and numberOfDays it should calculate final amount in real', async() => {
        ...
        const expected = carService.currenyFormat.format(244.40)
    ...
    it('given a customer and a car category it should return a transcation receipt', async() => {
        const car = mocks.validCar
        const carCategory = {
        ...
        const expectedAmount = carService.currenyFormat.format(206.80)
